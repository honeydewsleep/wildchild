...
module male()   intersection() { thread_male(j_root_r, j_depth, j_pitch, j_len, 1, 0, 96, 48, j_crest_deg);
...
module female() difference() { ring(); thread_female_cavity(j_root_r, j_depth, j_pitch, j_len + 1, j_clr, 1, 0, 96, 48, j_crest_deg); }
