...
pcb          = [86.5, 50.0];   // PCB outline; USB end faces +x
pcb_t        = 1.6;
pcb_holes    = [[3.5, 3.5], [83.0, 3.5], [3.5, 46.5], [83.0, 46.5]]; // from the (-x,-y) PCB corner
pcb_hole_d   = 3.0;
glass        = [69.0, 50.0];   // display module footprint (for the engraved outline)
